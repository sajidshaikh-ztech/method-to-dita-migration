...
public class WorkProductDefinitionId implements Serializable {
    private String workProductID;
    private String contextID;

    public WorkProductDefinitionId() {}
    public WorkProductDefinitionId(String workProductID, String contextID) {
    ...
    public boolean equals(Object o) {
        ...
        WorkProductDefinitionId that = (WorkProductDefinitionId) o;
