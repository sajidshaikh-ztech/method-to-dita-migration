...
public class PursuitSupportId implements Serializable {
    private String contextID;
    private String guidanceID;

    public PursuitSupportId() {}
    public PursuitSupportId(String contextID, String guidanceID) {
    ...
    public boolean equals(Object o) {
        ...
        PursuitSupportId that = (PursuitSupportId) o;
