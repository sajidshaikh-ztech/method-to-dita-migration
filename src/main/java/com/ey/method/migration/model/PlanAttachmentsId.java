...
public class PlanAttachmentsId implements Serializable {
    private String contextID;
    private String guidanceID;

    public PlanAttachmentsId() {}
    public PlanAttachmentsId(String contextID, String guidanceID) {
    ...
    public boolean equals(Object o) {
        ...
        PlanAttachmentsId that = (PlanAttachmentsId) o;
