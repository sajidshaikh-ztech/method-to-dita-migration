...
public class GettingStartedId implements Serializable {
    private String contextID;
    private String guidanceID;

    public GettingStartedId() {}
    public GettingStartedId(String contextID, String guidanceID) {
    ...
    public boolean equals(Object o) {
        ...
        GettingStartedId that = (GettingStartedId) o;
