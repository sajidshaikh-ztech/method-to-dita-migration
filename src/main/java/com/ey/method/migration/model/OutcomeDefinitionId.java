...
public class OutcomeDefinitionId implements Serializable {
    private String workProductID;
    private String contextID;

    public OutcomeDefinitionId() {}
    public OutcomeDefinitionId(String workProductID, String contextID) {
    ...
    public boolean equals(Object o) {
        ...
        OutcomeDefinitionId that = (OutcomeDefinitionId) o;
